...
import GetLocalData from './src/sceens/GetLocalData';
import ViewLocalData from './src/sceens/ViewLocalData';
...
function GetDataLocal() {
  return(
    <Stack.Navigator>
      <Stack.Screen name="GetLocalData" component={GetLocalData} options={{headerShown: false}}/>
